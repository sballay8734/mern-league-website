...
export default function ComparePage() {
  ...
  const owner1ParticipatedPlayoffs =
    ownerOne?.yearly[selectedYear].participated &&
    ownerOne?.yearly[selectedYear].playoffStats.participated === true
      ? true
      : false
  const owner2ParticipatedPlayoffs =
    ownerTwo?.yearly[selectedYear].participated &&
    ownerTwo?.yearly[selectedYear].playoffStats.participated === true
      ? true
      : false
                    ...
                    <div className="h2h-content-wrapper h2h-column disable-scrollbars">
                      <div className="h2h-content h2h-content-wrapper">
                        ...
                        <div className="stat-names">
                          <div className="main-cell cell stat stat-title">
                            Stat
                          </div>
                          ...
                          <div className="cell stat stat-one">
                            Avg. Pts v Field
                          </div>
                    ...
                    <div className="h2h-content-wrapper disable-scrollbars">
                      <div className="h2h-content h2h-content-wrapper">
                          ...
                          <div className="cell finished">
                            <span className="stat-value">
                              {ownerOne && owner1Participated === true ? (
                                <div>
                                  {
                                    ownerOne?.yearly[selectedYear].combinedStats
                                      .finishPlace
                                  }
                                </div>
                              ) : (
                            ...
                            {ownerOne &&
                              ownerTwo &&
                              owner1Participated === true &&
                              owner2Participated === true &&
                              ownerOne?.yearly[selectedYear].combinedStats
                                .finishPlace <
                                ownerTwo?.yearly[selectedYear].combinedStats
                                  .finishPlace && (
                                <div className="plus-minus-and-icon">
                                  <span className="plus-minus green">
                                    {ownerTwo?.yearly[selectedYear]
                                      .combinedStats.finishPlace -
                        ...
                        <div className="owner-stats owner-two-stats">
                          ...
                          <div className="cell finished">
                            <span className="stat-value">
                              {ownerTwo && owner2Participated === true ? (
                                <div>
                                  {
                                    ownerTwo?.yearly[selectedYear].combinedStats
                                      .finishPlace
                        ...
                        <div className="owner-stats owner-one-stats">
                          ...
                          <div className="cell finished">
                            <span className="stat-value">
                              {ownerOne && owner1Participated === true ? (
                                <div>
                                  {
                                    ownerOne?.yearly[selectedYear].regSznStats
                                      .finishPlace
                                  }
                                </div>
                              ) : (
                            ...
                            {ownerOne &&
                              ...
                              ownerOne?.yearly[selectedYear].regSznStats
                                .finishPlace <
                                ownerTwo?.yearly[selectedYear].regSznStats
                                  .finishPlace && (
                                <div className="plus-minus-and-icon">
                                  <span className="plus-minus green">
                                    {ownerTwo?.yearly[selectedYear].regSznStats
                                ...
                                <>
                                  {
                                    ownerOne.scheduleSwap[ownerTwo.ownerName]
                                      .yearly[selectedYear].scheduleSwapWins
                                  }
                                  {" - "}
                                  {
                                    ownerOne.scheduleSwap[ownerTwo.ownerName]
                                      .yearly[selectedYear].scheduleSwapLosses
                                  }
                                  {" - "}
                                  {
                                    ownerOne.scheduleSwap[ownerTwo.ownerName]
                                      .yearly[selectedYear].scheduleSwapTies
                                  }
                                </>
                              ) : (
                                "-"
                            ...
                            <div className="plus-minus-and-icon">
                              {ownerOne &&
                                ...
                                ownerOne.scheduleSwap[ownerTwo.ownerName]
                                  ...
                                  <>
                                    {ownerOne.scheduleSwap[ownerTwo.ownerName]
                                      .yearly[selectedYear].scheduleSwapWinPct >
                                      ownerOne.yearly[selectedYear].regSznStats
                                        .winningPct &&
                                    ownerOne.scheduleSwap[ownerTwo.ownerName]
                                      .yearly[selectedYear].scheduleSwapWinPct -
                          ...
                          <div className="cell etew-record stat-value">
                            {ownerOne && owner1Participated === true ? (
                              <>
                                {
                                  ownerOne.yearly[selectedYear]
                                    .everyTeamEveryWeekStats.ETEWWins
                                }{" "}
                                -{" "}
                                {
                                  ownerOne.yearly[selectedYear]
                                    .everyTeamEveryWeekStats.ETEWLosses
                                }{" "}
                                -{" "}
                                {
                                  ownerOne.yearly[selectedYear]
                                    .everyTeamEveryWeekStats.ETEWTies
                                }
                              </>
                            ) : (
                              "DNP"
                          ...
                          <div className="cell avgPf">
                            ...
                            {ownerOne &&
                              ...
                              owner1Participated === true &&
                              owner2Participated === true &&
                              ownerOne?.yearly[selectedYear].regSznStats.avgPF >
                                ownerTwo?.yearly[selectedYear].regSznStats
                                  .avgPF && (
                                <div className="plus-minus-and-icon">
                                  <span className="plus-minus green">
                          ...
                          <div className="cell avgPa">
                            ...
                            {ownerOne &&
                              ...
                              owner1Participated === true &&
                              owner2Participated === true &&
                              ownerOne?.yearly[selectedYear].regSznStats.avgPA >
                                ownerTwo?.yearly[selectedYear].regSznStats
                                  .avgPA && (
                                <div className="plus-minus-and-icon">
                                  <span className="plus-minus green">
                        ...
                        <div className="owner-stats owner-two-stats">
                          ...
                          <div className="cell avgPf">
                            ...
                            {ownerTwo &&
                              ...
                              owner1Participated === true &&
                              owner2Participated === true &&
                              ownerTwo?.yearly[selectedYear].regSznStats.avgPF >
                                ownerOne?.yearly[selectedYear].regSznStats
                                  .avgPF && (
                                <div className="plus-minus-and-icon">
                                  <span className="arrow-icon green">
                          ...
                          <div className="cell avgPa">
                            ...
                            {ownerTwo &&
                              ...
                              owner1Participated === true &&
                              owner2Participated === true &&
                              ownerTwo?.yearly[selectedYear].regSznStats.avgPA >
                                ownerOne?.yearly[selectedYear].regSznStats
                                  .avgPA && (
                                <div className="plus-minus-and-icon">
                                  <span className="arrow-icon green">
                      ...
                      <div className="h2h-content h2h-content-wrapper">
                        <div className="owner-stats owner-one-stats">
                          ...
                          <div className="cell finished">
                            ...
                            {ownerOne &&
                              ownerTwo &&
                              owner1ParticipatedPlayoffs === true &&
                              owner2Participated === true &&
                              ownerOne?.yearly[selectedYear].regSznStats
                                .finishPlace <
                                ownerTwo?.yearly[selectedYear].regSznStats
                          ...
                          <div className="cell record owner-one-record">
                            {ownerOne && owner1ParticipatedPlayoffs === true ? (
                              <>
                                {
                                  ownerOne.yearly[selectedYear].playoffStats
                                    .wins
                                }{" "}
                                -{" "}
                                {
                          ...
                          <div className="cell win-pct">
                            ...
                            {ownerOne &&
                              ...
                              ownerOne?.yearly[selectedYear].playoffStats
                                .winningPct >
                                ownerTwo?.yearly[selectedYear].playoffStats
                                  .winningPct && (
                                <div className="plus-minus-and-icon">
                                  <span className="plus-minus green">
                                    {(
                                      ownerOne?.yearly[selectedYear]
                                        .playoffStats.winningPct -
                                      ownerTwo?.yearly[selectedYear]
                                        .playoffStats.winningPct
                                    ).toFixed(1)}
                                    %
                        ...
                        <div className="owner-stats owner-two-stats">
                          ...
                          <div className="cell finished">
                            ...
                            {ownerTwo &&
                              ownerOne &&
                              owner1Participated === true &&
                              owner2ParticipatedPlayoffs === true &&
                              ownerTwo?.yearly[selectedYear].regSznStats
                                .finishPlace <
                                ownerOne?.yearly[selectedYear].regSznStats
                                  .finishPlace && (
                      ...
                      <div className="h2h-content h2h-content-wrapper">
                        ...
                        <div className="owner-stats owner-one-stats">
                            ...
                            <span className="stat-value">
                              ...
                              ownerTwo.yearly[selectedYear].participated ===
                                ...
                                <>
                                  {
                                    ownerOne.scheduleSwap[ownerTwo.ownerName]
                                      .allTime.scheduleSwapWins
                                  }
                                  {" - "}
                                  {
                                    ownerOne.scheduleSwap[ownerTwo.ownerName]
                                      .allTime.scheduleSwapLosses
                                  }
                                  {" - "}
                                  {
                                    ownerOne.scheduleSwap[ownerTwo.ownerName]
                                      .allTime.scheduleSwapTies
                                  }
                                </>
                              ) : (
                                "-"
                          ...
                          <div className="cell etewWinPct">
                            <span className="stat-value">
                              {ownerOne &&
                                ownerOne?.bonusStats.everyTeamEveryWeek.winPct.toFixed(
                                  1
                                )}
                              %
                            </span>
                            ...
                            {ownerOne &&
                              ...
                              ownerOne?.bonusStats.everyTeamEveryWeek.winPct >
                                ownerTwo?.bonusStats.everyTeamEveryWeek
                                  .winPct && (
                                <div className="plus-minus-and-icon">
                                  <span className="plus-minus green">
                                    {(
                                      ownerOne?.bonusStats.everyTeamEveryWeek
                                        .winPct -
                                      ownerTwo?.bonusStats.everyTeamEveryWeek
                                        .winPct
                                    ).toFixed(1)}
                        ...
                        <div className="owner-stats owner-two-stats">
                          ...
                          <div className="cell etewWinPct">
                            <span className="stat-value">
                              {ownerTwo &&
                                ownerTwo?.bonusStats.everyTeamEveryWeek.winPct.toFixed(
                                  1
                                )}
                              %
                            </span>
                    ...
                    <div className="h2h-content-wrapper disable-scrollbars">
                      <div className="h2h-content h2h-content-wrapper">
                        ...
                        <div className="owner-stats owner-one-stats">
                          ...
                          <div className="cell win-pct">
                            <span className="stat-value">
                              {ownerOne?.allTime.playoffs.POwinningPct.toFixed(
                                1
                              )}
                              %
                            </span>
                          ...
                          <div className="cell total-points-for">
                            <span className="stat-value">
                              {ownerOne?.allTime.playoffs.POpointsFor.toFixed(
                                1
                              )}
                            </span>
                            {ownerOne &&
                          ...
                          <div className="cell total-points-against">
                            <span className="stat-value">
                              {ownerOne?.allTime.playoffs.POpointsAgainst.toFixed(
                                1
                              )}
                            </span>
                            {ownerOne &&
                        ...
                        <div className="owner-stats owner-two-stats">
                          ...
                          <div className="cell win-pct">
                            <span className="stat-value">
                              {ownerTwo?.allTime.playoffs.POwinningPct.toFixed(
                                1
                              )}
                              %
                            </span>
                          ...
                          <div className="cell total-points-for">
                            <span className="stat-value">
                              {ownerTwo?.allTime.playoffs.POpointsFor.toFixed(
                                1
                              )}
                            </span>
                            {ownerTwo &&
                          ...
                          <div className="cell total-points-against">
                            <span className="stat-value">
                              {ownerTwo?.allTime.playoffs.POpointsAgainst.toFixed(
                                1
                              )}
                            </span>
                            {ownerTwo &&
                    ...
                    <div className="h2h-content-wrapper disable-scrollbars">
                      <div className="h2h-content h2h-content-wrapper">
                        <div className="owner-stats owner-one-stats">
                          ...
                          <div className="cell total-points-against">
                            <span className="stat-value">
                              {ownerOne?.allTime.combined.pointsAgainst.toFixed(
                                1
                              )}
                            </span>
                            {ownerOne &&
                        ...
                        <div className="owner-stats owner-two-stats">
                          ...
                          <div className="cell total-points-against">
                            <span className="stat-value">
                              {ownerTwo?.allTime.combined.pointsAgainst.toFixed(
                                1
                              )}
                            </span>
                            {ownerTwo &&
